...
from .camera.attention_processor import XFormersAttnProcessor as CustomizedXFormerAttnProcessor
from .camera.attention_processor import PoseAdaptorXFormersAttnProcessor

# if hasattr(F, "scaled_dot_product_attention"):
#     from models_diffusers.camera.attention_processor import PoseAdaptorAttnProcessor2_0 as PoseAdaptorAttnProcessor
#     from models_diffusers.camera.attention_processor import AttnProcessor2_0 as CustomizedAttnProcessor
# else:
from .camera.attention_processor import PoseAdaptorAttnProcessor
from .camera.attention_processor import AttnProcessor as CustomizedAttnProcessor
...
class UNetSpatioTemporalConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def set_pose_cond_attn_processor(
        self,
        add_spatial=False,
        add_temporal=False,
